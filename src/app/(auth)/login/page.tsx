    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center bg-slate-50 p-4 overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-0 overflow-hidden">
                <div className="absolute -top-40 -right-40 h-[500px] w-[500px] rounded-full bg-amber-500/10 blur-[120px] animate-pulse-glow" />
                <div className="absolute -bottom-40 -left-40 h-[400px] w-[400px] rounded-full bg-slate-400/15 blur-[100px] animate-pulse-glow delay-200" />
            </div>
            ...
            <div className="relative z-10 w-full max-w-md animate-slide-up">
                ...
                <div className="bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-8 sm:p-10 shadow-xl shadow-slate-200/50">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <SparkButton variant="tertiary" type="button" onClick={() => signIn("github")} className="h-11">
                        ...
                        <SparkButton variant="tertiary" type="button" onClick={() => signIn("google")} className="h-11">
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100">
                        <p className="text-center text-sm text-slate-500">
                            ...
                            <Link href="/register" className="font-semibold text-amber-600 hover:text-amber-700 transition-colors duration-200">
